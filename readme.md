...
* [Licença](#-licença)
* [Contacto & suporte](#-contacto--suporte)
...
1. **Só queres ler?**
   Vai a **[distribuicao/](./distribuicao/)** e descarrega a edição pretendida (PDF comum ou tema escuro) ou o **kit ZIP**.
...
* **[distribuicao/](./distribuicao/):** artefactos prontos (PDFs, ZIP do kit).
* **[estrutura/](./estrutura/):** estrutura e organização editorial do documento em LaTeX.
* **[extras/](./extras/):** conteúdos adicionais/auxiliares.
* **[fontes/](./fontes/):** tipos de letra utilizados.
* **[formularios/](./formularios/):** formulários e requerimentos úteis.
* **[gpt-personalizado/](./gpt-personalizado/):** configuração utilizada na criação do GPT IA personalizado.
* **[graficos/](./graficos/), [imagens/](./imagens/):** elementos visuais.
* **[modelos/](./modelos/):** modelos de cartas/ofícios e textos prontos a adaptar.
* **[suportes-juridicos/](./suportes-juridicos/), [suportes-juridicos-md/](./suportes-juridicos-md/):** bases legais e compilações de suporte (em formatos diversos).
...
**Domínio Público — [Unlicense](./license.md).**
Podes usar, copiar, modificar e distribuir sem restrições. Atribuição é apreciada mas não obrigatória. 

## 📫 Contacto & suporte

* **Issues:** usa a aba [Issues](../../issues) para bugs, dúvidas ou pedidos de melhoria.
